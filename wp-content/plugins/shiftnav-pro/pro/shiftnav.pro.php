...
function shiftnav_content_top_image( $instance_id ){
	...
	if( $image_id ):
		...
		$image_link = shiftnav_op( 'image_link' , $instance_id )
	?>
...
function shiftnav_main_toggle_right_edge( $main_toggle = false , $target_id , $id ){
	...
	<span class="shiftnav-main-toggle-content-after"><a href="tel:(069) 9028 7337 52" class="mobile-mob visible-xs"><i class="fa fa-phone-square" aria-hidden="true"></i> <span>(069) 9028 7337 52</span></a><?php do_action('icl_language_selector'); ?></span>
	<?php endif;
}
