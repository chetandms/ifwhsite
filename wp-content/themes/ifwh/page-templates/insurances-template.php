<?php
/**
 * Template Name: Insurances Template
**/
                ...
                <div class="col-md-8">
                    <div id="main-content">
                        ...
                        <?php endwhile; // end of the loop. ?> 
                            ...
                            <div id="insurances-acc">

                                <?php if( have_rows('insurances_list') ): ?>
                                  <?php while( have_rows('insurances_list') ): the_row(); ?>

                                        <span class="span-title"><?php the_sub_field('insurance_name'); ?></span>
